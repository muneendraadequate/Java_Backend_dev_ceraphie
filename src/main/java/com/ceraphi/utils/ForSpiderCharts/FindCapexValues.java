...
//
//        // Set constant values
//        BigDecimal mediumWellCapex = new BigDecimal(String.valueOf(deep_well_CAPEX));
...
//
//            // Calculate P/I
//            BigDecimal PI = cumulativeCashFlow[x - 1].divide(deep_well_CAPEX, 2, RoundingMode.HALF_UP).add(BigDecimal.ONE);
//
...
//}
    ...
    public  List<LCOHYearResponse> lcohCapex( double medium_well_OPEX,double selling_price,double discount_rate) {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            // Calculate P/I
            Double PI = cumulativeCashFlow[x - 1] / deep_well_CAPEX + 1.0;
