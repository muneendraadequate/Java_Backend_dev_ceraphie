...
public class FindHeatSellingValues {
...
//
//        // Set constant values
//        BigDecimal mediumWellCapex = new BigDecimal(String.valueOf(medium_well_CAPEX));
//        BigDecimal mediumWellOpex = new BigDecimal(String.valueOf(medium_well_OPEX));
//        BigDecimal productionValue = new BigDecimal("8600");
//        BigDecimal price = new BigDecimal(String.valueOf(selling_price));
